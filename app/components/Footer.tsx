...
const Footer = () => {
	...
	const featuredEvents = events.filter(event => event.hienthi !== false).slice(0, 6);
		...
		<div className='w-full bg-[#095400] min-h-[265px]'>
			...
			>
				<div className='col-span-1 mt-8 mb-4'>
					<h3 className='font-medium text-gray-300 text-sm'>Event Sales</h3>
				...
				<div className='col-span-1 mt-8 mb-4'>
					<h3 className='font-medium text-gray-300 text-sm'>Resources</h3>
					<ul className='list-none mt-4'>
						<li className='mb-2'>
				...
				<div className='col-span-1 mt-8 mb-4'>
					<h3 className='font-medium text-gray-300 text-sm'>Company</h3>
					<ul className='list-none mt-4'>
						<li className='mb-2'>
							<Link
				...
				<div className='col-span-1 mt-8 mb-4'>
					<h3 className='font-medium text-gray-300 text-sm'>Notices</h3>
					<ul className='list-none mt-4'>
						<li className='mb-2'>
							<Link
								href='/page/privacy-policy'
				...
				<div className='col-span-1 mt-8 mb-4'>
					<h3 className='font-medium text-gray-300 text-sm'>Follow Us On</h3>
