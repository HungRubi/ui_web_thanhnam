	...
	return (
		...
		>
			...
			<div className='flex-1'>
				<div className='w-full h-[180px] flex items-center justify-center mb-3 cursor-pointer' onClick={onDeal}>
					<Image
						src={imageSrc}
						alt={title}
						width={300}
				...
				<div className='flex items-center justify-between mb-3'>
					<div>
						{oldPrice && <span className='text-red-500 line-through mr-2'>${oldPrice}</span>}
