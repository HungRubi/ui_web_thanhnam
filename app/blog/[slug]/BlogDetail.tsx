        ...
        <div className="container mt-4 px-3 grid grid-cols-1 md:grid-cols-4 mx-auto gap-x-4">
          <div className="col-span-3 bg-white p-5">
            ...
            <div className={`flex items-center justify-start gap-x-2.5 my-5`}>
              ...
              />
              <p className="text-sm text-gray-400">{currentNews.lastUpdate || currentNews.formatDate || "2 days ago"}</p>
            </div>
            {currentNews.content && (
              <div className="leading-8 text-gray-700" dangerouslySetInnerHTML={{ __html: currentNews.content }} />
            )}
            {currentNews.description && <p className="leading-8 text-gray-700">{currentNews.description}</p>}
          </div>
